...
namespace JsonSpanParser
{
    ...
    public readonly struct JArrayNode
    {
        ...
        internal static JArrayNode Parse(ReadOnlySpan<char> source, int startSearchIndx, int selfIndx, IMemoryContext memoryContext, out int memoryIndx, out int endValueIndx)
        {
